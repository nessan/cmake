...
When we import a library into our project, we often get inundated with compiler warnings from that library's header files.
...
Assuming the `systematize.cmake` file is in a top-level `cmake` directory, you might invoke it as follows:
